  ...
  <v-container fluid>
    ...
    <v-card>
      <v-card-title>
        ...
        <span class="title">Customer Credit/Debit Cards</span>
        <v-spacer></v-spacer>
      ...
      <v-card-text>
            ...
            <v-layout wrap row>
              <v-flex xs12 sm12 md12 lg12>
                ...
                <v-list-tile>
                  ...
                  <v-list-tile-content>
                    <v-list-tile-title class="body-2">
                      {{ getCustomerStatus(customerDataById.status) }}
                    </v-list-tile-title>
                  </v-list-tile-content>
                </v-list-tile>
              </v-flex>
        ...
        <v-flex xs12 sm12 md12 lg12>
          <v-data-table
            :headers="headers"
            :items="customerCreditDebitCardList"
            :search="search"
            class="elevation-1"
          >
...
export default {
  ...
  mounted() {
    ...
    this.getCustomerCreditDebitCardDataByCustomerId(
