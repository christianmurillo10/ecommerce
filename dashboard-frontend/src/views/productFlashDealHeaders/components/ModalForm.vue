            ...
            <v-flex xs12 sm12 md6>
              ...
              >
                ...
                <v-date-picker v-model="formData.date_from" no-title scrollable>
                  ...
                  <v-btn flat color="primary" @click="$refs.date_from.save(formData.date_from)">OK</v-btn>
                </v-date-picker>
              </v-menu>
            </v-flex>
            <v-flex xs12 sm12 md6>
              ...
              >
                ...
                <v-date-picker v-model="formData.date_to" no-title scrollable>
                  ...
                  <v-btn flat color="primary" @click="$refs.date_to.save(formData.date_to)">OK</v-btn>
                </v-date-picker>
              </v-menu>
            </v-flex>
          </v-layout>
