              ...
              <v-hover v-slot:default="{ hover }">
                ...
                >
                  <v-container fill-height justify-center>
                    ...
                    <span class="title">Affordable Products</span>
                  </v-container>
                </v-card>
              </v-hover>
            </v-container>
              ...
              <v-hover v-slot:default="{ hover }">
                ...
                >
                  <v-container fill-height justify-center>
                    ...
                    <span class="title">27/4 Online Support</span>
                  </v-container>
                </v-card>
              </v-hover>
            </v-container>
      ...
      <v-flex xs12 sm12 md12 lg12>
        <v-layout row wrap>
          <v-flex xs12 sm12 md6 lg6>
            <v-container>
              <v-card flat class="blue white--text" height="250" width="620">
                <v-container fill-height justify-center>
          ...
          <v-flex xs12 sm12 md6 lg6>
            <v-container>
              <v-card flat class="blue-grey lighten-3" height="250" width="620">
                <v-container fill-height justify-center>
                  <span class="display-3">250 x 620</span>
                </v-container>
              </v-card>
