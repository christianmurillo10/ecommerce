                        ...
                        <v-slide-group mandatory class="px-4" show-arrows>
                          ...
                          >
                            <v-card
                              ...
                              width="70px"
                              v-on:click="
                                changeMainImage(productImage.file_path)
                              "
                              @click="toggle"
                            >
                              <v-card-text>
                              ...
                              <v-container>
                                <v-layout row wrap>
                                  ...
                                  <v-btn
                                    ...
                                    :disabled="!valid"
                                  >
                                    <v-icon left dark>mdi-cart</v-icon>ADD TO
                                    CART
                                  </v-btn>

                                  <!-- Dialog for Add to Cart -->
                                  <v-dialog
                                    v-model="dialogAddToCart"
                                    max-width="800"
                                  >
                                    <v-card>
                                      <v-card-title class="mb-n3">
                                        <v-spacer></v-spacer>
                                        <v-icon @click="dialogAddToCart = false"
                                          >mdi-close</v-icon
                                        >
                                      </v-card-title>
                                      <v-card-title
