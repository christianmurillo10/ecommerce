          ...
          <v-flex xs12 sm12 md8 lg8 offset-md2 offset-lg2>
            <v-card fluid>
              <v-card-title>
                ...
                <v-spacer></v-spacer>
                <span class="caption">Already member? <router-link v-bind:to="'/login'">Login</router-link> here.</span>
              </v-card-title>
              <v-card-text>
                      ...
                      <v-flex xs12 sm12 md6 lg6>
                        <v-layout wrap row>
                          <v-flex xs12 sm12 md12 lg12>
                            <v-btn block tile color="success" type="submit">Sign up</v-btn>
                          </v-flex>
                          <v-flex xs12 sm12 md12 lg12>
                            <span class="caption">
                              By clicking "SIGN UP", I agree to E-Commerce 
                              <router-link v-bind:to="'/terms-and-conditions'">Terms & Conditions</router-link> 
                              and
                              <router-link v-bind:to="'/privacy-policy'">Privacy Policy</router-link> 
                            </span>
                          </v-flex>
                          <v-flex xs12 sm12 md12 lg12>
                            <v-layout wrap row>
                              ...
                              <v-flex xs12 sm12 md12 lg12>
                                  <v-btn block tile dark color="indigo"><v-icon left>mdi-facebook</v-icon>Facebook</v-btn>
                              </v-flex>
                              <v-flex xs12 sm12 md12 lg12>
                                <v-btn block tile dark color="red"><v-icon left>mdi-google-plus</v-icon>Google</v-btn>
                              </v-flex>
                            </v-layout>
                          </v-flex>
                        </v-layout>
