...
module.exports = {
  ...
  create: async (req, res) => {
    ...
    try {
      ...
      initialValues = _.pick(params, ['code', 'name', 'description', 'created_at']);
  ...
  update: async (req, res) => {
    ...
    try {
      // Pre-setting variables
      initialValues = _.pick(params, ['code', 'name', 'description']);
  ...
  search: async (req, res) => {
    ...
    try {
      // Pre-setting variables
      query = `SELECT id, code, name, description, created_at, updated_at FROM banks WHERE CONCAT(code, name) LIKE ? AND is_deleted = ${NO};`;
