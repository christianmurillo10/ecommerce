...
module.exports = {
   ...
   * @routes POST /productSubCategory/create
   */
  create: async (req, res) => {
    ...
    try {
      ...
      criteria = { where: { name: params.name, product_category_id: params.product_category_id }, include: [{ model: Model.ProductCategories, as: 'productCategories' }] };
  ...
  /**
   * Update
   * @route PUT /productSubCategory/update/:id
   * @param req
   * @param res
   * @returns {never}
   */
    ...
    try {
      ...
      if (!_.isEmpty(data)) {
        await data.update(initialValues)
          .then(() => Model.ProductSubCategories.findByPk(data.id, criteria)
          .then(finalData => {
            res.json({
              status: 200,
  ...
  /**
   * Delete
   * @route PUT /productSubCategory/delete/:id
   * @param req
   * @param res
   * @returns {never}
   */
  ...
  /**
   * Search
   * @route POST /productSubCategory/search/:value
   * @param req
   * @param res
   * @returns {never}
   */
   ...
   * @route GET /productSubCategory/findAllbyProductCategoryId/:productCategoryId
   * @param req
   * @param res
   * @returns {never}
   */
  ...
  /**
   * Find by id
   * @route GET /productSubCategory/:id
   * @param req
   * @param res
   * @returns {never}
   */
